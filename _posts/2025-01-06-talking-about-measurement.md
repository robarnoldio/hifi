...
People who take measurements seriously tend to state the uncertainty in their measurements, in order to convey both the accuracy and precision.

Even without a statement of uncertainty, the number of significant digits in a measurement can imply a precision.
...
- Frequency, measured in Hz (Hertz), is equivalent to cycles per second.
- Sound pressure level, mesured in B (bels) or more commonly dB (decibels) is 
