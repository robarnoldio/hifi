...
- Watt: Measures the electrical power; equal dimensionally to current x voltage.
...
- 3 dB corresponds to twice the power in Watts (-3 dB to half). So if your system generates a level of 77 dB sPL with 1 Watt applied, applying 2 watts will generate an 80 dB SPL. 
